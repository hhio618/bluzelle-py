...
_CRUDVALUE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='creator', full_name='bluzelle.curium.crud.CrudValue.creator', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='uuid', full_name='bluzelle.curium.crud.CrudValue.uuid', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='key', full_name='bluzelle.curium.crud.CrudValue.key', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='value', full_name='bluzelle.curium.crud.CrudValue.value', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='lease', full_name='bluzelle.curium.crud.CrudValue.lease', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='height', full_name='bluzelle.curium.crud.CrudValue.height', index=5,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='metadata', full_name='bluzelle.curium.crud.CrudValue.metadata', index=6,
...
CrudValue = _reflection.GeneratedProtocolMessageType('CrudValue', (_message.Message,), {
