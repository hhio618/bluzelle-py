...
goproto_unkeyed = _descriptor.FieldDescriptor(
  ...
  is_extension=True, extension_scope=None,
  serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key)
CASTREPEATED_FIELD_NUMBER = 65000
castrepeated = _descriptor.FieldDescriptor(
  name='castrepeated', full_name='gogoproto.castrepeated', index=64,
...
nullable = _descriptor.FieldDescriptor(
  name='nullable', full_name='gogoproto.nullable', index=65,
...
embed = _descriptor.FieldDescriptor(
  name='embed', full_name='gogoproto.embed', index=66,
...
customtype = _descriptor.FieldDescriptor(
  name='customtype', full_name='gogoproto.customtype', index=67,
...
customname = _descriptor.FieldDescriptor(
  name='customname', full_name='gogoproto.customname', index=68,
...
jsontag = _descriptor.FieldDescriptor(
  name='jsontag', full_name='gogoproto.jsontag', index=69,
...
moretags = _descriptor.FieldDescriptor(
  name='moretags', full_name='gogoproto.moretags', index=70,
...
casttype = _descriptor.FieldDescriptor(
  name='casttype', full_name='gogoproto.casttype', index=71,
...
castkey = _descriptor.FieldDescriptor(
  name='castkey', full_name='gogoproto.castkey', index=72,
...
castvalue = _descriptor.FieldDescriptor(
  name='castvalue', full_name='gogoproto.castvalue', index=73,
...
stdtime = _descriptor.FieldDescriptor(
  name='stdtime', full_name='gogoproto.stdtime', index=74,
...
stdduration = _descriptor.FieldDescriptor(
  name='stdduration', full_name='gogoproto.stdduration', index=75,
...
wktpointer = _descriptor.FieldDescriptor(
  name='wktpointer', full_name='gogoproto.wktpointer', index=76,
