...
from bluzelle.codec.cosmos.auth.v1beta1 import (
...
_QUERYMODULEACCOUNTSRESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="accounts",
            full_name="cosmos.auth.v1beta1.QueryModuleAccountsResponse.accounts",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
            ...
            is_extension=False,
            extension_scope=None,
            serialized_options=b"\312\264-\016ModuleAccountI",
            file=DESCRIPTOR,
            create_key=_descriptor._internal_create_key,
        ),
    ],
...
QueryModuleAccountsRequest = _reflection.GeneratedProtocolMessageType(
...
QueryModuleAccountsResponse = _reflection.GeneratedProtocolMessageType(
