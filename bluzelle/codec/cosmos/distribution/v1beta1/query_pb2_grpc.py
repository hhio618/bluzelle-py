...
class QueryServicer(object):
    ...
    def ValidatorOutstandingRewards(self, request, context):
        """ValidatorOutstandingRewards queries rewards of a validator
        address."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details("Method not implemented!")
        raise NotImplementedError("Method not implemented!")
    ...
    def ValidatorCommission(self, request, context):
        """ValidatorCommission queries accumulated commission for a
        validator."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details("Method not implemented!")
        raise NotImplementedError("Method not implemented!")
    ...
    def DelegationRewards(self, request, context):
        """DelegationRewards queries the total rewards accrued by a
        delegation."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details("Method not implemented!")
        raise NotImplementedError("Method not implemented!")
