...
from bluzelle.codec.cosmos.crypto.multisig.v1beta1 import multisig_pb2 as cosmos_dot_crypto_dot_multisig_dot_v1beta1_dot_multisig__pb2
from bluzelle.codec.cosmos.base.v1beta1 import coin_pb2 as cosmos_dot_base_dot_v1beta1_dot_coin__pb2
from bluzelle.codec.cosmos.tx.signing.v1beta1 import signing_pb2 as cosmos_dot_tx_dot_signing_dot_v1beta1_dot_signing__pb2
...
_SIGNDOCJSON = _descriptor.Descriptor(
  name='SignDocJSON',
  full_name='cosmos.tx.v1beta1.SignDocJSON',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='body', full_name='cosmos.tx.v1beta1.SignDocJSON.body', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='auth_info', full_name='cosmos.tx.v1beta1.SignDocJSON.auth_info', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='chain_id', full_name='cosmos.tx.v1beta1.SignDocJSON.chain_id', index=2,
      number=3, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='account_number', full_name='cosmos.tx.v1beta1.SignDocJSON.account_number', index=3,
      number=4, type=4, cpp_type=4, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='sign_doc_sha256_hash', full_name='cosmos.tx.v1beta1.SignDocJSON.sign_doc_sha256_hash', index=4,
...
_SIGNDOCJSON.fields_by_name['body'].message_type = _TXBODY
_SIGNDOCJSON.fields_by_name['auth_info'].message_type = _AUTHINFO
...
DESCRIPTOR.message_types_by_name['SignDocJSON'] = _SIGNDOCJSON
...
SignDocJSON = _reflection.GeneratedProtocolMessageType('SignDocJSON', (_message.Message,), {
  'DESCRIPTOR' : _SIGNDOCJSON,
  '__module__' : 'cosmos.tx.v1beta1.tx_pb2'
  # @@protoc_insertion_point(class_scope:cosmos.tx.v1beta1.SignDocJSON)
  })
_sym_db.RegisterMessage(SignDocJSON)
