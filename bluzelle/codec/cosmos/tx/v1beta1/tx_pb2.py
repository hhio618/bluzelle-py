...
from bluzelle.codec.cosmos.crypto.multisig.v1beta1 import (
    multisig_pb2 as cosmos_dot_crypto_dot_multisig_dot_v1beta1_dot_multisig__pb2,
)
from bluzelle.codec.cosmos.tx.signing.v1beta1 import (
...
_SIGNDOCJSON = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="body",
            full_name="cosmos.tx.v1beta1.SignDocJSON.body",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="auth_info",
            full_name="cosmos.tx.v1beta1.SignDocJSON.auth_info",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="chain_id",
            full_name="cosmos.tx.v1beta1.SignDocJSON.chain_id",
            index=2,
            number=3,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="account_number",
            full_name="cosmos.tx.v1beta1.SignDocJSON.account_number",
            index=3,
            number=4,
            type=4,
            cpp_type=4,
        ...
        _descriptor.FieldDescriptor(
            name="sign_doc_sha256_hash",
            full_name="cosmos.tx.v1beta1.SignDocJSON.sign_doc_sha256_hash",
            index=4,
            number=5,
            type=12,
            cpp_type=9,
...
_MODEINFO_MULTI.fields_by_name[
    "bitarray"
].message_type = cosmos_dot_crypto_dot_multisig_dot_v1beta1_dot_multisig__pb2._COMPACTBITARRAY
...
SignDocJSON = _reflection.GeneratedProtocolMessageType(
    "SignDocJSON",
    (_message.Message,),
    {
