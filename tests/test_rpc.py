                    ...
                    "txs": [
                        {
                            ...
                            "proof": {
                                "root_hash": "1893CD73FECA803A5385E6F7585EEAA83B66F1488CA82F4CD3DF53A85208D6FC",
                                ...
                                "proof": {
                                    "total": "1",
                                    "index": "0",
                                    "leaf_hash": "GJPNc/7KgDpTheb3WF7qqDtm8UiMqC9M099TqFII1vw=",
                                    "aunts": [],
                                },
                            },
                        }
                    ...
                    "txs": [
                        {
                            ...
                            "tx_result": {
                                "code": 0,
                                "data": "ChEKD1VwZGF0ZUNydWRWYWx1ZQ==",
                            ...
                            "proof": {
                                "root_hash": "5339EFDC9F2AA2D0D53B671AD96B4B7B3EB58DC02CB25B4EAC771E09446E7530",
                                "data": "",
                                "proof": {
                                    "total": "1",
                                    "index": "0",
                                    "leaf_hash": "Uznv3J8qotDVO2ca2WtLez61jcAssltOrHceCURudTA=",
                                    "aunts": [],
                                },
                            },
                        }
            ...
            return {
                ...
                "result": {
                    "response": {
                        ...
                        "index": "0",
                        "key": None,
                        "value": "ChAKBHVibnQSCDk5OTQ2MjQ2",
                        "proofOps": None,
                        "height": "860035",
                        "codespace": "",
                    }
...
class Tx:
    def Create(self, msg_create, **kwargs):
        return Tendermint34ClientMock(host="testnet.com", port=1212).call(
            msg_create, params=kwargs
        )
